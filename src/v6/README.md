...
V6.1.1 is the current stable AnimeKai RPC release. It keeps the proven V6 playback/RPC path and adds polish around browsing presence, faster state transitions, and health reporting.
